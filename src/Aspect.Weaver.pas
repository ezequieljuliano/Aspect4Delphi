...
type
  ...
  public
    class function New(interceptor: TAspectInterceptor): IAspectWeaver; static;
  end;
...
class function TAspectWeaverFactory.New(interceptor: TAspectInterceptor): IAspectWeaver;
begin
